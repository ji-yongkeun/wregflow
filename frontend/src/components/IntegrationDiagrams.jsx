...
export function IntegrationDiagrams({ data }) {
  useEffect(() => {
    // Mermaid 렌더링
    if (window.mermaid) {
  ...
  return (
    <div className="integration-diagrams-container">
      <h2 className="diagrams-title">📊 통합 분석 다이어그램</h2>
...
export default IntegrationDiagrams
